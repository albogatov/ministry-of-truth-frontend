                      ...
                      <v-card-text>
                        <v-container>
                          ...
                          <v-text-field
                              ...
                              v-model="selectedEmployee.numberOfChildren"
                          ...
                          <v-select v-model="selectedEmployee.department" id="departmentList" :items="AllDepartments"
                                    label="Choose department"
                                    :item-text="'name'" :item-value="'id'">
                            <option v-for="dep in AllDepartments" v-bind:key="dep.id" v-bind:value="dep.title">
                              {{ dep.name }}
                            </option>
                          </v-select>

                          <v-select v-model="selectedEmployee.position" id="positionList" :items="positions"
                          ...
                          <v-text v-if="selectedEmployee.position != null"
                                  light
                                  label="Access Level"
                                  v-model="selectedEmployee.position.accessLevel"
                                  name="AccessLevel"
                                  :color=changeColor()
                                  background-color=#EDF2F7
                                  outlined
